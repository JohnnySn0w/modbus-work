...
Both metric and non-metric Modbus Bridge tables use one-based manual register numbers. Metric measurements start at 1; non-metric measurements start at 129. Each table contains eight measurements and three status entries, for 11 entries total.
