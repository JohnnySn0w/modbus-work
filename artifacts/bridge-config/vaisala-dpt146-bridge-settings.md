...
## Modbus Bridge validation result

The corrected table was imported into the bench Modbus Bridge and its detailed “Read All Data Points” test completed with **8 successful reads and 0 exceptions**.

| Quantity | Validated Modbus Bridge reading |
|---|---:|
