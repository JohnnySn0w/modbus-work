...
E5 sessions, DPT146 adapter acquisition, verified table programming and local file workflows are implemented. Native IAQ sessions, firmware image inspection/flashing, and complete multi-product Synetica support are not. Runtime state is never sourced from Python snapshots.
