...
The initial profile uses the reviewed D12/F12 Modbus map: 13 E5 bridge points, low-word-first float32 (HL), concentration, temperature, loop output and status. The original 40001-style register notation is normalized to zero-based PDU addresses; primary concentration 40043-40044 is PDU 42-43.
